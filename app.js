...
function createMediaCard(item) {
  ...
  const approveLabel = approveIconBtn.querySelector(".approve-label");
  if (item.status === "Approved") {
    approveIconBtn.classList.add("approved");
    tickIcon.textContent = "✔";
    if (approveLabel) approveLabel.textContent = "Approved";
  } else {
    approveIconBtn.classList.remove("approved");
    tickIcon.textContent = "✕";
    if (approveLabel) approveLabel.textContent = "Needs Review";
  }
